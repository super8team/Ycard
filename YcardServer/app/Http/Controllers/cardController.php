...
class CardController extends BaseController
{
    ...
    public function updateStudent(Request $req){ // 학생 업데이트
        ...
        //$user = $student->updateStudent($req->get('sname'),$req->get('dname'),$req->get('id'),$req->get('snum'),$req->get('date'),$req->get('image'));
        $user = $student->updateStudent($req->get('sname'),$req->get('dname'),$req->get('id'),$req->get('snum'),$req->get('date'));
